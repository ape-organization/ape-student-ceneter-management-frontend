...
export class ManagementService {
  private readonly apiUrl = 'http://localhost:3000/api/management';
  ...
  async getAll(): Promise<any[]> {
    try {
      ...
      console.error('Failed to get all management items:', error);
      throw error;
    }
  }
  ...
  async getById(id: number | string): Promise<any> {
    try {
      ...
      console.error(`Failed to get management item with id ${id}:`, error);
      throw error;
    }
  }
  ...
  async create(data: any): Promise<any> {
    try {
      ...
      console.error('Failed to create management item:', error);
      throw error;
    }
  }
  ...
  async update(id: number | string, data: any): Promise<any> {
    try {
      ...
      console.error(`Failed to update management item with id ${id}:`, error);
      throw error;
    }
  }
  ...
  async delete(id: number | string): Promise<any> {
    try {
      ...
      console.error(`Failed to delete management item with id ${id}:`, error);
      throw error;
    }
  }
}